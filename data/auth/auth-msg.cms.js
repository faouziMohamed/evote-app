...
exports.getAuthSuccessMessage = exports.getAuthErrorMessage = void 0;
var messages = {
  en: {
    errors: {
      ...
      noValuePassed: 'Invalid request, please submit request with a value in parameter'
    },
    success: {
  ...
  fr: {
    errors: {
      ...
      missingPassword: 'Veuillez remplir le formulaire, le champ mot de passe est manquant',
      username: "Veuillez remplir le formulaire, le champ nom d'utilisateur est manquant",
      email: 'Veuillez remplir le formulaire, le champ email est manquant',
      birthdate: 'Veuillez remplir le formulaire, le champ date de naissance est manquant',
      ...
      passwordConstraint: 'Les contraintes de mot de passe ne sont pas satisfaites',
      ...
      needToLoginAPI: 'Vous devez vous connecter pour accéder à cette ressource',
      ...
      noValuePassed: 'Requête invalide, veuillez soumettre une requête avec une valeur dans le paramètre'
    },
    success: {
...
var getAuthErrorMessage = function getAuthErrorMessage(errorName) {
  var lang = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'en';
  return messages[lang].errors[errorName];
};

exports.getAuthErrorMessage = getAuthErrorMessage;

var getAuthSuccessMessage = function getAuthSuccessMessage(successName) {
  var lang = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'en';
  return messages[lang].success[successName];
};

exports.getAuthSuccessMessage = getAuthSuccessMessage;